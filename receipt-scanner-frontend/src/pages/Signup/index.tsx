...
import { Container, Title, Input, Button, GoogleButton, Divider, ErrorText } from "./styles";
...
const Signup: React.FC = () => {
  const { fullName, age, email, cellNumber, password, error, handleChange, handleSubmit, googleSignUpUrl } =
    useSignupController();
  ...
  return (
    <Layout>
      <Container>
        ...
        <GoogleButton href={googleSignUpUrl}>
          <GoogleIcon />
          Sign up with Google
        </GoogleButton>
